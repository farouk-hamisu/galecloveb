...
const Savings = () => {
  ...
  const savingsGoals = [
    { id: 1, name: t('savings_page.emergency_fund'), target: 10000, current: 6500, color: 'bg-green-500' },
    { id: 2, name: t('savings_page.vacation'), target: 5000, current: 2000, color: 'bg-blue-500' },
    { id: 3, name: t('savings_page.new_car'), target: 25000, current: 8000, color: 'bg-purple-500' },
  ];
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-2xl font-bold text-foreground mb-4">
                    ...
                    <span className="text-sm font-normal text-muted-foreground ml-2">
                      {t('savings_page.of')} {formatCurrency(goal.target)}
                    </span>
                  </p>
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">{t('savings_page.create_new_goal')}</span>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="font-semibold text-foreground mb-3">{t('savings_page.tips_title')}</h3>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>{t('savings_page.tip1')}</li>
            <li>{t('savings_page.tip2')}</li>
            <li>{t('savings_page.tip3')}</li>
            <li>{t('savings_page.tip4')}</li>
          </ul>
        </motion.div>
      </div>
    </DashboardLayout>
